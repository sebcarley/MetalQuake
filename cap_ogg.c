...
static qbool SCR_CaptureVideo_Ogg_OpenLibrary(void)
{
...
#elif defined(MACOSX)
		"libogg.dylib",
		// SEPTEMBER2 E (2026-09-10): the bare name resolves through nothing on this
		// machine (the 2026-08-17 libvorbis fact); Homebrew's copy, then /usr/local
	...
	const char* dllnames_ve [] =
	{
		...
		// SEPTEMBER2 E (2026-09-10): the bare name resolves through nothing on this
		// machine (the 2026-08-17 libvorbis fact); Homebrew's copy, then /usr/local
		"/opt/homebrew/lib/libvorbisenc.dylib",
	...
	const char* dllnames_th [] =
	{
		...
		// SEPTEMBER2 E (2026-09-10): the bare name resolves through nothing on this
		// machine (the 2026-08-17 libvorbis fact); Homebrew's copy, then /usr/local
		"/opt/homebrew/lib/libtheora.dylib",
