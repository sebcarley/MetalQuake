...
// M5 (F3): a Q1 *teleport/*rift starfield -- the surface swirl gives these mode 2
// (slow rotation + churn) where WATERALPHA liquids get mode 1. Set by the
// name-based classification only, so it rides replacement textures through the
// m5_liquidflags arm exactly like the liquid flags themselves.
#define MATERIALFLAG_M5TELEPORT 0x00400000
