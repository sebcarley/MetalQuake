...
// METAL.md Phase 4a: dump the last completed frame's counters to the console
// (the on-screen r_speeds overlay is unreadable from a headless parity run)
void R_Stats_Dump_f(struct cmd_state_s *cmd);
