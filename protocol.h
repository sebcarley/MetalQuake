...
#define EF_M5BALL				262144		// M5 ball lightning (qc/m5ball.qc): the ball and its arc-owner helper. Was EF_UNUSED18. The client reads it to draw the plasma knot, colour and flicker the ball's light, weight it in the fog, and root its arcs on the moving entity
